...
- Manage and synchronize updates for one or multiple files
The included command references make it simple to track, commit, and synchronize project changes between your local system and GitHub.
